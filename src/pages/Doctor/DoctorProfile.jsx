    ...
    return profileData && (
        <div>
            <div className='flex flex-col gap-4 m-5'>
                <div>
                    <img className='bg-pink-500/80 w-full sm:max-w-64 rounded-lg' src={profileData.image} alt="" />
                </div>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    {
                        isEdit
                            ? <button onClick={updateProfile} className='px-4 py-1 border border-pink-600 text-sm rounded-full mt-5 hover:bg-pink-600 hover:text-white transition-all'>Save</button>
                            : <button onClick={() => setIsEdit(prev => !prev)} className='px-4 py-1 border border-pink-600 text-sm rounded-full mt-5 hover:bg-pink-600 hover:text-white transition-all'>Edit</button>
                    }
